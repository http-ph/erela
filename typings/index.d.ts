...
declare module 'erela.js/structures/Manager' {
    ...
    export interface Manager {
            ...
            /**
                * Emitted when a Node has an warning.
                * @event Manager#nodeWarn
                */
            on(event: "nodeWarn", listener: (node: Node, error: Error) => void): this;
            /**
                * Emitted when a Node sends a pong
                * @event Manager#nodePong
                */
            on(event: "nodePong", listener: (node: Node) => void): this;
            /**
    ...
    export type SearchPlatform = "youtube" | "youtubemusic" | "soundcloud" | "odysee" | "yandex";
...
declare module 'erela.js/structures/Node' {
    ...
    export class Node {
            ...
            protected upgrade({ headers }: IncomingMessage): void;
            protected open(): void;
    ...
    export interface NodeOptions {
            ...
            /** Whether to configure resuming or not */
            configureResuming?: boolean;
            /** Region of lavalink Node */
            region?: "europe" | "usa";
    }
...
declare module 'erela.js/structures/Player' {
    ...
    import { Filters } from "erela.js/structures/Filters";
    ...
    export class Player {
            ...
            /** If the player is moving to a new Lavalink Node */
            moving: boolean;
            /** The Manager. */
            manager: Manager;
            /**
...
declare module 'erela.js/structures/Utils' {
    ...
    export type Sizes = "0" | "1" | "2" | "3" | "default" | "sddefault" | "mqdefault" | "hqdefault" | "maxresdefault";
...
declare module 'erela.js/structures/Filters' {
